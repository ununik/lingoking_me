...
$app->get('/:trustSalesforceCom/:rest/:rss/:eu2',
		function ($trustSalesforceCom = 'trust.salesforce.com',
				$rest = 'rest', $rss = 'rss', $eu2 = 'EU2')
		{
			$keyWordsError = array('unable');
			$keyWordsFixed = array('complete', 'success', 'Resolved');
			$content = file_get_contents ('https://' . $trustSalesforceCom . '/' . $rest . '/' . $rss . '/' . $eu2); //'https://trust.salesforce.com/rest/rss/EU2'
			$items = array();
